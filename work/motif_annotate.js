  ...
  $J( "span#sop" ).click(function () {
    ...
    $J( "span#cop" ).click(function () {
       ...
       {gpfd0.style.display='';}
        ...
        document.getElementById('myframegpfd0').src="preparedoor.php?st=0";
       ...
       {gpfd1.style.display='';}
        ...
        document.getElementById('myframegpfd1').src="controldoor.php?st=0";
       ...
       {gpfd2.style.display='';}
        ...
        document.getElementById('myframegpfd2').src="preparedoor.php?st=0";
       ...
       {gpfd3.style.display='';}
        ...
        document.getElementById('myframegpfd3').src="preparedoor.php?st=0";
       ...
       {gpfd4.style.display='';}
        ...
        document.getElementById('myframegpfd4').src="preparedoor.php?st=0";
